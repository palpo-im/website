...
const SALVO_CARGO_FILE = path.join(__dirname, '..', 'PalpoCargo.toml');
...
// 解析 PalpoCargo.toml 文件
function parsePalpoCargo() {
  try {
    ...
    console.error('Error parsing PalpoCargo.toml:', error);
  }
}
